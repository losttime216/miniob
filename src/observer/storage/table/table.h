...
public:
  ...
  RC update_record(const Record &record, const Value *values, const FieldMeta *field_meta);
  ...
  // TODO refactor
  RC create_index(Trx *trx, const FieldMeta *field_meta, const char *index_name, const IndexMeta::IndexType &index_type);
